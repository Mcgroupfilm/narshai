    ...
    if gl == False:
        ...
        if k == False:
            ...
            if files:
                ...
                buttons = [[                        
                    InlineKeyboardButton('📥𝐔𝐏𝐃𝐀𝐓𝐄📥', callback_data=f'option#{reporter}')
                ]]
                reply_markup = InlineKeyboardMarkup(buttons)
...
#                                                       user_name= '' if username is None else username,
        ...
        if query.from_user.id in ADMINS:                     
            ...
            await query.answer(f"𝐇𝐞𝐥𝐥𝐨 {query.from_user.first_name} 𝐓𝐡𝐢𝐬 𝐀𝐝𝐦𝐢𝐧 𝐎𝐧𝐥𝐲..!!!⚠️", show_alert=True)
...
#        return await query.answer("𝐂𝐥𝐨𝐬𝐞𝐝", show_alert=True) 
        ...
        buttons = [[
            InlineKeyboardButton('♻️ᴍᴏᴅᴜʟᴇꜱ♻️', callback_data='modules1')
        ], [
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.STICKER.format(temp.B_NAME),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
